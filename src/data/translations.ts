...
export const TRANSLATIONS = {
  en: {
    ...
    hero: {
      ...
      subtitle: "end-to-end",
      positioning: "SaaS B2B & B2G · Design Systems · AI-driven design & prototyping · Claude Code · Figma MCP",
      desc: "15 years of product design, from strategic framing with decision-makers to craft and delivery. Design systems, user research, complex business interfaces, micro-interactions. I use Claude Code and Figma MCP to go from concept to deployed prototype in hours.",
      descShort: "15 years of product design. I help teams frame the right problem, prototype fast, and ship what matters.",
  ...
  fr: {
    ...
    hero: {
      ...
      title: "Lead Product Designer",
      subtitle: "end-to-end",
      positioning: "SaaS B2B & B2G \u00b7 Design Systems \u00b7 Design et prototypage IA \u00b7 Claude Code \u00b7 Figma MCP",
      desc: "15 ans de conception produit, du cadrage strat\u00e9gique avec les d\u00e9cideurs au craft et \u00e0 la livraison. Design systems, recherche utilisateur, interfaces m\u00e9tier complexes, micro-interactions. J\u2019utilise Claude Code et Figma MCP pour passer du concept au prototype d\u00e9ploy\u00e9 en quelques heures.",
      descShort: "15 ans de conception produit. J\u2019aide les \u00e9quipes \u00e0 cadrer le bon probl\u00e8me, prototyper vite et livrer ce qui compte.",
