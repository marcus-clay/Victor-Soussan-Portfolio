...
export const TRANSLATIONS = {
  en: {
    ...
    hero: {
      ...
      desc: "15 years building digital products. I help teams frame the right problem, prototype fast, and ship in short cycles. I work alongside PM and engineering to build what lasts: design systems, documented components, and practices that let the team move without dependency. I use Claude Code and Figma MCP to go from concept to deployed prototype in hours.",
      descShort: "15 years building digital products. I help teams frame the right problem, prototype fast, and ship what matters.",
  ...
  fr: {
    ...
    hero: {
      ...
      desc: "15 ans de conception produit. J\u2019aide les \u00e9quipes \u00e0 cadrer le bon probl\u00e8me, prototyper vite et livrer en cycles courts. Je travaille avec le PM et l\u2019engineering pour construire ce qui dure : design systems, composants document\u00e9s, pratiques qui permettent \u00e0 l\u2019\u00e9quipe d\u2019avancer sans d\u00e9pendance. J\u2019utilise Claude Code et Figma MCP pour passer du concept au prototype d\u00e9ploy\u00e9 en quelques heures.",
