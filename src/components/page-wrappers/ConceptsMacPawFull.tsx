        ...
        <div className="ml-auto hidden md:flex items-center gap-0.5">
          {([['home','Home'],['work','Work'],['about','About'],['blog','Resources'],['gallery','Interfaces']] as [PageId,string][]).map(([id,label]) => (
            <motion.button key={id} whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} transition={spB} onClick={() => go(id)}
              className={`px-3 py-1.5 rounded-xl text-[13px] font-medium transition-all ${page === id ? 'text-white' : 'text-gray-500 hover:text-gray-900 hover:bg-gray-50'}`}
          ...
          <F delay={0.15}>
            <div className="flex gap-3 flex-wrap mt-8">
              <motion.button whileHover={{ scale: 1.03, y: -1 }} whileTap={{ scale: 0.97 }} transition={spB} onClick={() => go('work')}
                className="group px-7 py-3.5 text-white rounded-2xl text-[15px] font-semibold flex items-center gap-2" style={{ background: blue }}>
              ...
              <motion.button whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} transition={spB} onClick={() => go('about')}
                className="px-7 py-3.5 rounded-2xl text-[15px] text-gray-500 border border-gray-200 hover:border-gray-300 font-medium">About me</motion.button>
            </div>
          </F>
        </div>
      </section>
        ...
        <F>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <motion.button whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} transition={spB}
              className="px-8 py-4 text-white rounded-2xl text-[16px] font-semibold flex items-center justify-center gap-2" style={{ background: blue }}>Book a call <Calendar size={16} /></motion.button>
            <motion.button whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} transition={spB}
              className="px-8 py-4 rounded-2xl text-[16px] text-gray-500 border border-gray-200 flex items-center justify-center gap-2">Email <Envelope size={16} /></motion.button>
          </div>
        </F>
      </section>
