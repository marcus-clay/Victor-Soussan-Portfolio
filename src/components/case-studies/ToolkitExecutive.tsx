...
const TRANSLATIONS = {
  ...
  fr: {
    ...
    role: {
      title: 'Mon role',
      subtitle: 'Design produit de bout en bout, du prototype a la production dans une equipe lean de 3 personnes.',
      items: [
        { label: 'Seul product designer', detail: 'Phase de creation' },
        { label: 'Identite visuelle', detail: 'Guidelines & visuels cles' },
      ...
      context: 'J\'ai rejoint une equipe de trois : CEO avec expertise metier, lead dev construisant les fondations, et moi comme seul designer. Pas d\'equipe design, pas de researchers. Collaboration serree et validation utilisateur hebdomadaire.',
    },
    scope: {
      title: 'Perimetre',
      intro: 'Tout pour simplifier le quotidien des operateurs sur les chantiers.',
      areas: [
        {
          id: 'prototype',
          title: 'Prototype de Levee',
        ...
        },
        {
          id: 'core',
          title: 'Produit Core',
          description: 'Creation projet, gestion taches, documents, zones, suivi activite, collaboration equipe.',
          image: '/images/toolkit/desktop_-_chantier_-_details_-_v2.svg',
        },
        {
          id: 'planning',
          title: 'Planning Interactif',
          description: 'Canvas avance avec micro-interactions : zoom fluide, menus dynamiques, selection drag, operations batch.',
          image: '/images/toolkit/planning_-_v2.svg',
        },
        {
          id: 'mobile',
          title: 'Strategie Mobile',
          description: 'Vues responsive concues pour adaptation native iOS/Android. Patterns d\'interaction coherents.',
          image: '/images/toolkit/evolution_mobile_menu.svg',
        },
        {
          id: 'system',
      ...
      phases: [
        {
          ...
          title: 'Fondation',
          period: 'Mois 1-3',
          goal: 'Securiser le financement initial',
          deliverables: [
            'Authentification core (magic link)',
            'Navigation dual sidebar',
            'Workflow creation projet',
            'Bibliotheque taches & sequences',
            'Canvas planning v1',
            'Export PDF',
          ],
        },
        {
          ...
          deliverables: [
            'Systeme menu dynamic island',
            'Operations batch multi-selection',
            'Cartes taches affinees (v2)',
            'Zoom fluide (jour a trimestre)',
        ...
        },
        {
          ...
          goal: 'Mobile & scale',
          deliverables: [
            'Raffinement hierarchie visuelle',
            'Evolution navigation mobile',
            'Design platform-specific',
            'Enrichissement activite (photos)',
            'Scalabilite design system',
            '120+ ecrans livres',
          ],
        },
      ],
      ...
      items: [
        {
          ...
          subtitle: 'De v1 a v2',
          description: 'Systeme visuel evolue : poids reduit, contraste ameliore. 50+ taches visibles sans surcharge.',
          media: '/images/toolkit/planning_-_v2.svg',
          type: 'image' as const,
        },
        {
          ...
          description: 'Menu s\'adapte a la selection. Tache unique : edition. Multiples : operations batch.',
          media: '/videos/toolkit/video_-_task_manipulation.mp4',
          type: 'video' as const,
        },
        {
          ...
          description: 'Selection rectangle a travers zones. Appliquer parametres a 50+ taches d\'un coup.',
          media: '/videos/toolkit/video_-_batch_edition.mp4',
          type: 'video' as const,
        },
        {
          id: 'zoom',
          title: 'Zoom Fluide',
          subtitle: 'Vue jour a trimestre',
          description: 'Navigation timeline seamless des taches quotidiennes a la vue trimestrielle.',
          media: '/videos/toolkit/video_-_planning_-_zoom_dezoom.mp4',
          type: 'video' as const,
        },
      ],
    ...
    outcome: {
      ...
      metrics: [
        ...
        { value: 'Serie A', label: 'Financement', sublabel: 'Novembre 2025' },
        { value: '15+', label: 'Sites par client', sublabel: 'entreprise' },
      ],
    },
    testimonial: {
      quote: 'Victor a travaille avec Toolkit comme UX/UI designer des les premieres etapes. Il a transforme des exigences business complexes en parcours utilisateurs parfaitement adaptes. Grace a son experience, Victor a egalement etabli des systemes fondamentaux (UI kit, patterns d\'interaction) qui nous ont fait gagner un temps de developpement considerable.',
      author: 'Pierre-Marie Nigay',
