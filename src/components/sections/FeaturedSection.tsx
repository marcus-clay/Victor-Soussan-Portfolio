          ...
          >
            <div className="aspect-[16/9] overflow-hidden">
              <img
                ...
                className="block w-full h-full object-cover object-top group-hover:scale-[1.03] transition-transform duration-300 ease-out"
                loading="lazy"
              />
            </div>
            <div className="p-6 flex flex-col flex-1">
              ...
              <p className="text-base text-gray-500 leading-relaxed mb-4 flex-1 line-clamp-2">
                {isEn
              ...
              <span className="text-sm font-medium text-[#2D5CF3] flex items-center gap-1 group-hover:gap-1.5 transition-all">
