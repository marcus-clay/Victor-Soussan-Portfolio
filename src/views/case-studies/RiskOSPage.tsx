...
const CONTENT = {
  en: {
    ...
    designQuestionTitle: 'The question I was trying to answer',
    designQuestionP1: 'Can you build an interface where the AI qualifies and contextualizes an alert in real time, while keeping the analyst genuinely in charge of the decision?',
    designQuestionP2: 'Three principles shaped the prototype:',
    designPrinciples: [
    ...
    learningsTitle: 'Three things I took away from this project',
    learningsIntro: 'The core design challenge with AI-assisted decision tools is not automation. It is figuring out, at each step, what the AI should prepare and what the human should decide. Here are three mechanisms that proved especially useful in this context.',
    learning1Title: 'Showing the reasoning in real time builds trust faster than displaying a score.',
    learning1Text: 'When the AI streams its analysis word by word, the analyst can start forming their own judgment while reading. This feels collaborative. A confidence score shown after the fact, by contrast, asks for trust without offering any visibility into the process.',
    learning2Title: 'Delaying action buttons is a small friction with a large effect.',
    learning2Text: 'The decision buttons in RiskOS only appear once the AI analysis finishes streaming. In a high-pressure environment, this intentional pause gives the analyst just enough time to actually read the reasoning before acting. It slows the interface by a few seconds, but it protects against reflexive decisions.',
    learning3Title: 'Visible downstream effects make the analyst feel connected to the outcome.',
    learning3Text: 'After taking action, the interface shows what happened next: the Slack message, the customer SMS, the tracking ticket. This turns the tool from an isolated workspace into a visible node in a larger system. The analyst sees that their decision had real consequences, which reinforces both accountability and a sense of accomplishment.',
    learningsOutro: 'These patterns are not specific to fraud detection. They apply to any B2B context where an AI assists a human decision: compliance, medical triage, content moderation, incident management.',
  ...
  fr: {
    ...
    designQuestionTitle: 'La question que j\'essayais de résoudre',
    designQuestionP1: 'Peut-on construire une interface où l\'IA qualifie et contextualise une alerte en temps réel, tout en laissant à l\'analyste le contrôle effectif de la décision ?',
    designQuestionP2: 'Trois principes ont guidé le prototype :',
    designPrinciples: [
    ...
    learningsTitle: 'Trois enseignements que je retiens de ce projet',
    learningsIntro: 'Le vrai enjeu de design quand on construit un outil de décision assisté par IA, ce n\'est pas l\'automatisation. C\'est de déterminer, à chaque étape, ce que l\'IA doit préparer et ce que l\'humain doit décider. Voici trois mécanismes qui se sont révélés particulièrement utiles dans ce contexte.',
    learning1Title: 'Montrer le raisonnement en temps réel construit la confiance plus vite qu\'afficher un score.',
    learning1Text: 'Quand l\'IA déroule son analyse mot par mot, l\'analyste peut commencer à former son propre jugement en même temps qu\'il lit. Ça ressemble à une collaboration. Un score de confiance affiché après coup, en comparaison, demande de faire confiance sans donner aucune visibilité sur le processus.',
    learning2Title: 'Retarder les boutons d\'action est une petite friction qui a un grand effet.',
    learning2Text: 'Dans RiskOS, les boutons de décision n\'apparaissent qu\'une fois l\'analyse IA terminée. En environnement de forte pression, cette pause intentionnelle donne à l\'analyste juste assez de temps pour lire le raisonnement avant d\'agir. L\'interface est ralentie de quelques secondes, mais la qualité des décisions s\'en trouve protégée.',
    learning3Title: 'Rendre les effets visibles en aval reconnecte l\'analyste au résultat.',
    learning3Text: 'Après une action, l\'interface montre ce qui s\'est passé ensuite : le message Slack, le SMS client, le ticket de suivi. L\'outil passe d\'un espace de travail isolé à un nœud visible dans un système plus large. L\'analyste voit que sa décision a eu des conséquences réelles, ce qui renforce à la fois la responsabilité et le sentiment d\'accomplissement.',
    learningsOutro: 'Ces mécanismes ne sont pas propres à la détection de fraude. Ils s\'appliquent à tout contexte B2B où une IA assiste une décision humaine : conformité réglementaire, triage médical, modération de contenu, gestion d\'incidents.',
