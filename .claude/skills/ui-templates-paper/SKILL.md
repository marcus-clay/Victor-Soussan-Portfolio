---
name: ui-template-paper
description: Paper-textured, print-inspired UI design system template. Minimal colors, clean serif/sans typography, tactile surface qualities. Use when building UIs with a paper, print, editorial, or stationery aesthetic.
