---
name: ui-template-shadcn
description: Shadcn/ui-inspired UI design system template. Minimal clean components, monochrome palette (Geist + Fira Code), utility-first patterns. Use when building UIs with a shadcn/ui, monochrome, or utility-first aesthetic.
