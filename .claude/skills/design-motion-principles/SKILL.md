...
version: "1.1"
description: Motion and interaction design skill based on Emil Kowalski, Jakub Krehel, and Jhey Tompkins. Use when auditing, building, or improving UI animations, transitions, hover states, page transitions, user flow polish, interaction ergonomics, micro-interactions, or any motion design work. Also applies when polishing UI, improving perceived performance, refining enter/exit states, or enhancing navigation transitions. Provides per-designer perspectives with context-aware weighting.
---
